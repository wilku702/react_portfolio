export const trinitiData = {
  ...
  images: [
    {
      src: '/projects/triniti/01_start_page.webp',
  ...
  sections: [
    ...
    },
    {
      ...
      images: [
        {
          src: '/projects/triniti/03_staff_login_filled.webp',
          alt: 'Staff login screen with email and password fields filled',
          caption: 'Staff Login'
        },
        {
          src: '/projects/triniti/13_family_login.webp',
    ...
    },
    {
      ...
      images: [
        {
          src: '/projects/triniti/05_activities_tab.webp',
    ...
    },
    {
      ...
      images: [
        {
          src: '/projects/triniti/06_add_activity_modal.webp',
          alt: 'Add activity modal with category picker',
          caption: 'Category Selection'
        },
        {
          src: '/projects/triniti/06b_add_activity_filled.webp',
          alt: 'Add activity modal with all fields filled',
          caption: 'Details Entered'
        },
        {
          src: '/projects/triniti/07_activity_detail.webp',
    ...
    },
    {
      ...
      rightSide: {
        ...
        image: {
          src: '/projects/triniti/14_family_activities.webp',
