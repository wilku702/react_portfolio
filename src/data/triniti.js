export const trinitiData = {
  ...
  sections: [
    ...
    },
    {
      ...
      images: [
        {
          src: '/projects/triniti/03_staff_login_filled.jpg',
          alt: 'Staff login screen with email and password fields filled',
          caption: 'Staff Login'
        },
        {
          src: '/projects/triniti/13_family_login.jpg',
    ...
    },
    {
      ...
      images: [
        {
          src: '/projects/triniti/06_add_activity_modal.jpg',
          alt: 'Add activity modal with category picker',
          caption: 'Category Selection'
        },
        {
          src: '/projects/triniti/06b_add_activity_filled.jpg',
          alt: 'Add activity modal with all fields filled',
          caption: 'Details Entered'
        },
        {
          src: '/projects/triniti/07_activity_detail.jpg',
