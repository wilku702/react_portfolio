    ...
    <section className="flex flex-wrap">
      {articles.map((article, index) => (
        <motion.article
          ...
          className="group relative w-full md:w-1/2 h-80 md:h-[28rem] bg-cover bg-center flex items-center p-8 md:p-12 overflow-hidden transition-all duration-400 cursor-pointer"
